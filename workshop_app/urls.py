...
urlpatterns = [
    ...
    url(r'^search/?$', views.workshop_search, name='workshop_search'),
    url(r'^instructor_status/?$', views.workshop_status_instructor,
